// ============================================================
// 山 Shan — configuration
// Paste your three Supabase values here after creating the project.
// (Settings → API for the first two.) Nothing else to edit.
// The anon key is safe in client code: row-level security limits
// every row to your logged-in user.
// ============================================================
window.SHAN_CONFIG = {
